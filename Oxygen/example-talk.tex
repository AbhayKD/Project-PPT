...
\pdfinfo
{
  /Title       (Voice Controlled Personal AI Device and Connecting IOT Devices)
  /Author      (B.E. Computer Engineering Group 3)
}
...
\title[JASPER]{\Large{Voice Controlled Personal AI Device and Connecting IOT Devices}} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{\textbf{\footnotesize{Kapish Kaith \hspace{3em} 13CO022\\ Rohan Killedar \hspace{3em} 13CO037\\ Chaitanya Kulkarni \hspace{3em} 13CO038\\ Abhay Dekate \hspace{3em} 13CO401\\}}} % Your name
